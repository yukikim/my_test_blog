    ...
    return (
        <main className="mx-auto max-w-5xl p-6">
            <div className="text-center">
                <h1 className="text-5xl font-tokumin tracking-tight text-balance head-text-color sm:text-7xl">
                    忘却の記録<br /><span className="text-2xl tracking-normal">The Archive of Oblivion</span>
                </h1>
                <p className="mt-8 text-lg font-tokumin sub-text-color sm:text-xl/8 mb-4">
